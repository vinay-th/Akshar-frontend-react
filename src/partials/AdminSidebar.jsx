        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/*Manage People (Manage Student and Faculty)*/}
                  ...
                  return (
                      <React.Fragment>
                        <a
                            href="#0"
                            className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                                (pathname === '/admin/manageFaculty' || pathname.includes('dashboard')) && 'hover:text-slate-200'
                            }`}
                            onClick={(e) => {
                              e.preventDefault();
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span
                        className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Manage Departments</span>
                  </div>
                </NavLink>
              </li>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span
                          className="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">4</span>
                    </div>
                  </div>
                </NavLink>
              </li>
