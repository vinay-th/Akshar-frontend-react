...
function FacultySidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/Faculty/dashboard" className="block">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          (pathname === '/Faculty/manageFaculty' ||
                            pathname.includes('dashboard')) &&
              ...
              {/* Recent Lectures */}
              <SidebarLinkGroup
                activecondition={pathname.includes('recent-lectures')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/Faculty/recent-lectures"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes('recent-lectures') &&
                          'hover:text-slate-200'
                        }`}
                      >
                        <div className="flex items-center justify-between">
