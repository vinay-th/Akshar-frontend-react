...
function    DepartmentTableItem(props) {
  ...
  return (
      <tr>
          ...
          <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
              <div
                  className={`inline-flex font-medium rounded-full text-center px-2.5 py-0.5 ${statusColor(props.status)}`}>{props.departmentShortName}</div>
          </td>
          <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
              <div className="font-medium text-slate-800">
                  {(!props.teacherInfo || props.teacherInfo === "") ? "Yet not assigned":props.teacherInfo}
              </div>
          </td>
          ...
          <td className="px-3 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
              <div className="space-x-1">
                  <button className="text-slate-400 hover:text-slate-500 rounded-full"
                          aria-controls="edit-department-model" onClick={editDepartment}>
                  ...
                  <button className="text-rose-500 hover:text-rose-600 rounded-full" onClick={deleteDepartment}>
